...
atm_inputs(){
    ...
    datadir_hd="${icon_data_poolFolder}/atmo/${atmos_gridID}-${ocean_gridID}/hd/r0002"
    ...
    ln -sf "${datadir_hd}/hdstart_${aref_vs_lc}_${atmos_gridID}_${ocean_gridID}_mc_maxl_s_v1_1.nc" ./ic_land_hd.nc
}
...
lnd_inputs(){
    ...
    extpar_filename="${datadir_land}/icon_extpar4jsbach_${atmos_gridID}_20250708_tiles_jsb.nc"
