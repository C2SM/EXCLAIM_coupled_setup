...
atm_inputs(){
    ...
    #hardcode grid refinement when 0 should be included
    ln -sf "${datadir_hd}/hdpara_r2b10_${atmos_gridID}_${ocean_gridID}_mc_s_v1.nc" ./bc_land_hd.nc   #  mask for routing_scheme='full'
    ln -sf "${datadir_hd}/hdstart_r2b10_${atmos_gridID}_${ocean_gridID}_mc_s_v1_1.nc" ./ic_land_hd.nc
}
...
oce_inputs(){
    ...
    case "${initialiseOcean}" in
        "fromClimatology")
            ...
            ln -sf "${ocean_grid_folder}/ocean/initial_conditions/rhaak/R2B10L72_spinup.nc" ./initial_state.nc 
            ;;
        "fromRestart")
